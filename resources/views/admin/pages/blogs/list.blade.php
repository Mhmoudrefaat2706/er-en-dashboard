                ...
                <form id="createBlogForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="blog_category_id" id="createBlogCategory" required>
                            @foreach (\App\Models\BlogCategory::where("lang", app()->getLocale())->get() as $cat)
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" data-disable-on-submit class="btn btn-success">{{ __("Add") }}</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-body">
                <form id="editBlogForm" enctype="multipart/form-data">
                    ...
                    <div class="text-end">
                        <button type="button" class="btn btn-secondary"
                            data-bs-dismiss="modal">{{ __("Cancel") }}</button>
                        <button type="submit" data-disable-on-submit class="btn btn-primary">{{ __("Save Changes") }}</button>
                    </div>
                </form>
            </div>
        </div>
