...
Route::prefix('admin')->middleware('auth:admin')->name('admin.')->group(function () {
    ...
    // sections CRUD
    Route::get('home_banner', [SectionController::class, 'home_bannerindex'])->name('home_banner.index');
    Route::post('home_banner/store', [SectionController::class, 'home_bannerstore'])->name('home_banner.store');
    Route::put('home_banner/{section}', [SectionController::class, 'home_bannerupdate'])->name('home_banner.update');

    Route::get('featured', [SectionController::class, 'featuredindex'])->name('featured.index');
    Route::post('featured/store', [SectionController::class, 'featuredstore'])->name('featured.store');
    Route::put('featured/{section}', [SectionController::class, 'featuredupdate'])->name('featured.update');

    // Video Section Routes
    Route::get('video', [SectionController::class, 'videoIndex'])->name('video.index');
    Route::post('video/store', [SectionController::class, 'videoStore'])->name('video.store');
    Route::put('video/{section}', [SectionController::class, 'videoUpdate'])->name('video.update');
   });
