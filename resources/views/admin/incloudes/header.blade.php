...
<header id="page-topbar" style="height: 60px;">
    <div class="navbar-header d-flex align-items-center" style="height: 100%;">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown me-2">
                <button class="btn header-item waves-effect d-flex align-items-center gap-2"
                        type="button" id="langDropdown"
                        data-bs-toggle="dropdown" aria-expanded="false"
                        style="background-color:#4a6cf7; color:#fff; border-radius:30px;
                               padding:6px 16px; font-weight:600;
                               box-shadow:0 0 8px rgba(0,0,0,0.15); height: 40px; margin-top: 15px; transition:background .3s;">
                ...
                <ul class="dropdown-menu text-end" aria-labelledby="langDropdown">
                    <li>
                        <a class="dropdown-item @if (app()->getLocale() == "ar") active fw-bold @endif"
                           href="{{ url("lang/ar") }}">{{ __("العربية") }}</a>
                    </li>
                    <li>
                        <a class="dropdown-item @if (app()->getLocale() == "en") active fw-bold @endif"
                           href="{{ url("lang/en") }}">{{ __("English") }}</a>
                    </li>
                </ul>
            </div>
            <!-- Notifications -->
