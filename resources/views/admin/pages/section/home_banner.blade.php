...
@section("content")
    <div class="container-fluid">
        <div class="row">
            ...
            <form
                action="{{ isset($section) ? route("admin.home_banner.update", $section->id) : route("admin.home_banner.store") }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control" value="{{ $section->content["title"] ?? "" }}"
                        required>
                </div>
                        ...
                        <div class="d-flex mt-2 flex-wrap gap-2">
                            @foreach ($section->content["images"] as $img)
                                <div style="position: relative;">
                                    <img src="{{ asset("sections/" . $img) }}" width="100" class="rounded border">
                                </div>
                            @endforeach
                        </div>
                    </div>
