                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table-hover mb-0 table align-middle" id="socialTable">
                                    ...
                                    @foreach ($socials as $index => $social)
                                        <tr id="socialRow{{ $social->id }}">
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-sm btn-outline-secondary edit-social"
                                                    data-id="{{ $social->id }}">
                                                    <i class="bi bi-pencil-fill"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger delete-social"
                                                    data-id="{{ $social->id }}">
            ...
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-body">
                    <form id="createSocialForm">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label">{{ __("Social Media") }}</label>
                            <select class="form-select" id="createName" required>
                                <option value="">{{ __("Select Social Media") }}</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="createUrl" required>
            ...
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-footer border-0">
                    ...
                    <button type="button" class="btn btn-danger"
                        id="confirmDeleteSocialBtn">{{ __("Delete") }}</button>
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
                ...
                <tr id="socialRow${data.social.id}">
                    ...
                    <td class="text-center">
                        ...
                        Object.entries(data.errors).forEach(([key, val]) => {
                            ...
                            if (inputId) {
                                document.getElementById(inputId).classList.add(
                                    'is-invalid');
            ...
            document.addEventListener('click', e => {
                if (e.target.closest('.edit-social')) {
                    ...
                    document.getElementById('editName').value = row.querySelector('.social-name')
                        .textContent;
                    document.getElementById('editUrl').value = row.querySelector('.social-url').textContent;
                    document.getElementById('editStatus').value = row.querySelector('.social-status')
                        .textContent;
                ...
                if (e.target.closest('.delete-social')) {
                    ...
                    document.getElementById('deleteSocialName').textContent = row.querySelector(
                        '.social-name').textContent;
                    deleteModal.show();
                }
            });
